...
PixelCPEGenericESProducer = cms.ESProducer("PixelCPEGenericESProducer",
    ...
    # Edge cluster errors for non-layer 1 in microns (determined by looking at residual RMS) 
    EdgeClusterErrorX = cms.double( 50.0 ),                                      
    EdgeClusterErrorY = cms.double( 85.0 ),                                                     

    # Edge cluster errors for layer 1 in microns (determined by looking at residual RMS) 
