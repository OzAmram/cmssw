...
allTags["GenError"] = {
    ...
    'T23' : ( ','.join( [ 'SiPixelGenErrorDBObject_phase2_IT_v7.0.0_25x100_v2_mc' ,SiPixelGenErrorRecord,connectionString, "", "2021-04-08 23:00:00"] ), ),  # Mix of 3D and planar sensors, both are 25um (local-x) x 100 um (local-y), planar sensors are VBias = 350, 3d sensors are VBias = 30V, B = 0
}
...
allTags["Template"] = {
    ...
    'T23' : ( ','.join( [ 'SiPixelTemplateDBObject_phase2_IT_v7.0.0_25x100_v2_mc' ,SiPixelTemplatesRecord,connectionString, "", "2021-04-08 23:00:00"] ), ),  # Mix of 3D and planar sensors, both are 25um (local-x) x 100 um (local-y), planar sensors are VBias = 350, 3d sensors are VBias = 30V, B = 0
}
